...
class CommandTool(CommandToolInterface):
    ...
    def add_subparser(self, name, description) -> ArgumentParser:
        ...
        return self.subparsers.add_parser(name, description=description, formatter_class=HelpFormatter)
    ...
    def add_logging_args(parser:ArgumentParser) -> None:
        ...
        group.add_argument("-t", action="store_true", help="enable full exception tracebacks")
        group.add_argument("-w", action="store_true", help="enable wide log messages")
        group.add_argument("-x", action="store_true", help="enable extra-wide log messages")
