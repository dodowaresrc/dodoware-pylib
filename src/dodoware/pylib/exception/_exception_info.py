...
class ExceptionInfo:  # pylint: disable=too-few-public-methods
    """
    ...
    def __init__(self, exception: BaseException):
        ...
        if hasattr(exception, "__cause__") and isinstance(
            exception.__cause__, BaseException
        ):
            self.cause = ExceptionInfo(exception.__cause__)

        if hasattr(exception, "__context__") and isinstance(
            exception.__context__, BaseException
        ):
